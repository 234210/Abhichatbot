...
const API_KEY = "AIzaSyA2tuKD-t2jPJ3c4GxZVvGXTH_6vIUGXpk";
...
// Optional: Add click ripple or hover expand effect
document.addEventListener("mousedown", () => {
  circleCursor.style.transform = "translate(-50%, -50%) scale(1.5)";
  circleCursor.style.background = "#724ae8";
});
